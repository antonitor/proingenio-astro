                      ...
                      <NavigationMenuItem key={index}>
                        {link.submenu ? (
                          <>
                            ...
                            <NavigationMenuContent>
                              {link.label === "Departamentos" ? (
                                // Dos columnas y ancho mayor para Departamentos
                                <div className="grid gap-3 p-4 min-w-[340px] md:min-w-[500px] md:grid-cols-2">
                                  {link.items?.map((item, itemIndex) => (
                                    <ListItem
                                      key={itemIndex}
                                      title={item.label}
                                    ...
                                    <NavigationMenuLink asChild>
                                      ...
                                      >
                                        ...
                                        <p className="text-sm leading-tight text-muted-foreground">
                                          Oficina técnica especializada en
